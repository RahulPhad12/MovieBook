...
import {Button,CardActions,Typography,Card,CardContent,Rating,Modal,Paper} from "@mui/material";
    ...
    <div>
      <Card sx={{ maxWidth: 500, marginTop: "20px" }}>
        ...
        <CardContent>
          ...
          <Typography variant="body3" noWrap color="text.secondary">
           Release Date: {props.passed.release_date}
          </Typography>
        </CardContent>
